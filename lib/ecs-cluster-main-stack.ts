...
import {InstanceClass, InstanceSize, InstanceType, Port, Vpc} from "@aws-cdk/aws-ec2";
...
export class EcsClusterMainStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props: EcsClusterStackProps) {
        ...
        this.cluster.connections.allowFrom(props.loadBalancer, Port.allTcp(), 'Allow load balancer to connect to services in cluster.');
